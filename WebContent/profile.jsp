 					...
 					<div class="row">  
						...
						<!-- 	<div class="panel panel-info"> -->
								<div class="panel-heading">
									<h3 class="panel-title"><c:out value="${user.getFirstName()}  ${user.getLastName()}" />	</h3>
								</div>
								<div class="row">
									<div class=" col-md-9 col-lg-9 ">
										...
										<div class=form-actions><a href="address.do?action=edit" class="btn btn-primary">Edit Address</a></div>
									</div>
								</div>
							</div>
						</div>
